...
#   value = {
#     vm1 = "http://${google_compute_instance.virginia-apptest.network_interface[0].access_config[0].nat_ip}"
#     vm2 = "http://${google_compute_instance.saopaulo-apptest.network_interface[0].access_config[0].nat_ip}"
#     vm3 = "http://${google_compute_instance.netherlands1-apptest.network_interface[0].access_config[0].nat_ip}"
#   }
...
output "lb_static_ip_address" {
  ...
  value       = "http://${google_compute_address.virginia-lb.address}"
}
